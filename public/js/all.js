...
Opal.modules["UtilsPack"] = function(Opal) {
  ...
  Opal.add_stubs(['$call', '$[]', '$*', '$insert', '$<<', '$Native']);
  return (function($base) {
    var $UtilsPack, self = $UtilsPack = $module($base, 'UtilsPack');

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2;

    Opal.defn(self, '$after', TMP_1 = function $$after(delay) {
      var self = this, $iter = TMP_1.$$p, block = $iter || nil;
      if ($gvars.$ == null) $gvars.$ = nil;
    ...
    Opal.defn(self, '$js_new', TMP_2 = function $$js_new(func, $a_rest) {
      var self = this, args, $iter = TMP_2.$$p, block = $iter || nil;
...
Opal.modules["ConsoleSurprise"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (Opal.defn(self, '$initialize', TMP_1 = function $$initialize() {
      ...
      return $gvars.$.$console().$log("Right Platform console >>");
